...
const getAllBookHandler = (request, h) => {
  ...
  if (name) {
    const bookFilter = bookshelf.filter(
  ...
  if (reading) {
    const bookFilter = bookshelf.filter((book) => Number(book.reading) === Number(reading));
    const response = h.response({
      status: 'success',
      data: {
        books: bookFilter.map((book) => ({
  ...
  if (finished) {
    const bookFilter = bookshelf.filter((book) => Number(book.finished) === Number(finished));
    const response = h.response({
      status: 'success',
      data: {
        books: bookFilter.map((book) => ({
